...
layout (location = 6) in vec3 gradient;
layout (location = 7) in mat3 deformation_gradient_elastic;
layout (location = 10) in mat3 deformation_gradient_plastic;
...
layout (location = 5) out vec3 out_gradient;
layout (location = 6) out float out_je;
layout (location = 7) out float out_jp;
